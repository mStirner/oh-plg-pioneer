module.exports = (data, logger, init) => {
    return init([
        ...
        "store"
        //"foo"
    ], async (scope, [C_DEVICES, C_ENDPOINTS, C_PLUGINS, C_ROOMS, C_VAULT, C_STORE]) => {
        try {


            const device = "625c330e23ed9311d25efbee";
            const iface = "625c330e23ed9311d25efbef";
            const room = "62a4bbf0d9256b5e8d69889c";
            ...
            /*
                        C_ENDPOINTS.add({
                            ...
                            console.log(err || "AV Receiver endpoint added", item);
